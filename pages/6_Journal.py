...
def _render_gate():
    """PRO password gate — blue theme, amber PRO badge only. Same design as Module 3."""
    _card = C["card"]
    _muted = C["muted"]
    _text  = C["text"]
    _red   = C["red"]
    ...
    with col:
        # Card — blue border, amber PRO badge only
        st.markdown(
